                ...
                <div class="single-slider">
                    <div class="">
                        <div class="row no-gutters align-items-center ">
                            ...
                            <div class="col-lg-8 col-md-7"style="background: linear-gradient(30deg,hsla(0,0%,100%,.1),rgba(71,144,240,.507))">
                                <div class="slider-product-content">
                                    <h1 class="slider-title mb-10" data-animation="fadeInUp" data-delay="0.3s"><span>short</span> <span> sleeves</span> <span>shirt</span></h1>
                                    <p class="mb-25" data-animation="fadeInUp" data-delay="0.9s">This shirt is made in Indonesia<br> and 50% discount let's buy.</p>
                                    <a class="main-btn" href="{{ url('/home') }}" data-animation="fadeInUp" data-delay="1.5s"style="background: linear-gradient(30deg,hsla(0,0%,100%,.1),rgba(71,000,240,.507))">Explore More <i class="lni-chevron-right"></i></a>
                ...
                <div class="single-slider">
                        <div class="">
                            <div class="row no-gutters align-items-center">
                                ...
                                <div class="col-lg-8 col-md-7"style="background: linear-gradient(30deg,hsla(0,0%,100%,.1),rgba(71,144,240,.507))">
                                    <div class="slider-product-content">
                                        <h1 class="slider-title mb-10" data-animation="fadeInUp" data-delay="0.3s"><span>long</span> <span> sleeves</span> <span>shirt</span></h1>
                                        <p class="mb-25" data-animation="fadeInUp" data-delay="0.9s">This shirt is made in Indonesia<br> and 20% discount let's buy.</p>
                                        <a class="main-btn" href="{{ url('/home') }}" data-animation="fadeInUp" data-delay="1.5s"style="background: linear-gradient(30deg,hsla(0,0%,100%,.1),rgba(71,000,240,.507))">Explore More <i class="lni-chevron-right"></i></a>
                                    </div> <!-- slider product content -->
                                </div>
                            </div> <!-- row -->
                        ...
                        <div class="" >
                            <div class="row no-gutters align-items-center">
                                ...
                                <div class="col-lg-8 col-md-7" style="background: linear-gradient(30deg,hsla(0,0%,100%,.1),rgba(71,144,240,.507))">
                                    <div class="slider-product-content" >
                                        <h1 class="slider-title mb-10" data-animation="fadeInUp" data-delay="0.3s"><span>short</span> <span> sleeves</span> <span>shirt</span></h1>
                                        <p class="mb-25" data-animation="fadeInUp" data-delay="0.9s">This shirt is made in Indonesia<br> and free shipping let's buy.</p>
                                        <a class="main-btn text-light" href="{{ url('/home') }}" data-animation="fadeInUp" data-delay="1.5s"style="background: linear-gradient(30deg,hsla(0,0%,100%,.1),rgba(71,000,240,.507))">Explore More <i class="lni-chevron-right"></i></a>
                                    </div> <!-- slider product content -->
                                </div>
                            </div> <!-- row -->
                        </div> <!-- container -->
