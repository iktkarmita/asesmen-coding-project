        ...
        <body id="page-top" style="background: rgb(196, 217, 245)">
            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <!-- Topbar -->
                    <nav class="navbar navbar-expand navbar-light bg-gradient-dark  topbar  static-top shadow "style="background: linear-gradient(30deg,hsla(0,0%,100%,.1),rgba(71,144,240,.507))">
            ...
            <!-- Sidebar - Brand -->
            <ul class="navbar-nav wy-nav-side shift bg-gradient-dark sidebar sidebar-dark  accordion mainwrapper collapsed" id="accordionSidebar"  style="background: linear-gradient(90deg,hsla(0,0%,100%,.1),rgba(71,144,240,.507))">
